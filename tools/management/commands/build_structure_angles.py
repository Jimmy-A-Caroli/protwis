...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        if incremental_update:
            ...
            self.references = Structure.objects.all().exclude(structure_type__slug__startswith='af-').exclude(id__in=done_structures).prefetch_related('pdb_code','pdb_data','protein','state').order_by('protein')
        else:
            ...
            self.references = Structure.objects.all().exclude(structure_type__slug__startswith='af-').prefetch_related('pdb_code','pdb_data','protein','state').order_by('protein')
