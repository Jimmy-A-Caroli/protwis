...
def AJAX_Interactions(request):
    ...
    complex_objs = SignprotComplex.objects.filter(structure__pdb_code__index__in=selected_pdbs).prefetch_related('structure__protein')
    ...
    prot_conf = complex_objs.values_list('structure__protein__id', flat=True)
