...
class Command(BaseBuild):
    ...
    def main_func(self, positions, iteration, count, lock):
        ...
        while count.value < len(complexes):
            ...
            try:
                struct = Structure.objects.get(protein=con, pdb_code__index=sd['pdb'], structure_type__slug='af-peptide')
...
####################################################
            # protein anomalies
            scheme = struct.protein.residue_numbering_scheme
            try:
...
####################################################
            ...
            try:
                ...
                print('construction calculations done for {}. {} seconds.'.format(struct.protein.entry_name, diff))
            except Exception as msg:
                print(msg)
            ...
            try:
                ...
                diff = round(end - current,1)
                print('Create resides/rotamers done for {}. {} seconds.'.format(struct.protein.entry_name, diff))
            except Exception as msg:
                print(msg)
            ...
            for ligand in ligands:
                try:
                    ...
                    diff = round(end - current,1)
                    print('Interaction calculations done for {}. {} seconds.'.format(struct.protein.entry_name, diff))
                except Exception as msg:
                    print(msg)
